...
public class HiddenServiceHealthContributorAutoConfiguration extends
        CompositeHealthContributorConfiguration<HiddenServiceHealthIndicator, HiddenServiceSocket> {

    @Bean
    @ConditionalOnMissingBean(name = {"hiddenServiceHealthIndicator", "hiddenServiceHealthContributor"})
    public HealthContributor hiddenServiceHealthContributor(Map<String, HiddenServiceSocket> hiddenServiceSockets) {
