...
public interface BtcAbuseApiClient {
     ...
     * Check Address.
     *
     * <p>GET "https://www.bitcoinabuse.com/api/reports/check"
     *
     * <p>This report is cached and only updates once per hour.
     *
     * <p>Parameters
     ...
     * Complete Download.
     *
     * <p>GET "https://www.bitcoinabuse.com/api/download/{time_period}"
     *
     * <p>Returns a CSV file containing all reports within the given time period. The "1d" file is
