...
class LnurlAuthWalletUtilsTest {
    ...
    void itShouldCreateLinkingKeyForSiteWithRandomWallet() {
        ...
        ExtendedPrivateKey masterPrivateKey = DeterministicWallet.generate(new SecureRandom().generateSeed(256));
    ...
    void itShouldCreateLinkingKeyPathWithTestVectors() {
        ...
        KeyPath expectedKeyPath = new KeyPath("")
    ...
    void itShouldCreateLinkingKeyForSiteWithGivenWallet() {
        ...
        ExtendedPrivateKey masterPrivateKey = DeterministicWallet.generate(walletSeed);
