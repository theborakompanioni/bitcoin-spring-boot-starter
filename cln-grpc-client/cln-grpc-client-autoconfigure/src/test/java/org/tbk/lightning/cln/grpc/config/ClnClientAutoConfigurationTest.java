...
class ClnClientAutoConfigurationTest {
    ...
    void beansAreCreatedBase64Values() {
        this.contextRunner.withUserConfiguration(ClnClientAutoConfiguration.class)
                .withPropertyValues(
                        "org.tbk.lightning.cln.grpc.host=localhost",
                        "org.tbk.lightning.cln.grpc.port=10001",
                        // same as `src/test/resources/cln/test-ca.pem` but base64-encoded
                        ...
                        // same as `src/test/resources/cln/test-client.pem` but base64-encoded
                        ...
                        // same as `src/test/resources/cln/test-client-key.pem` but base64-encoded
    ...
    @Test
    void beansAreCreatedMixedValues() {
        this.contextRunner.withUserConfiguration(ClnClientAutoConfiguration.class)
                .withPropertyValues(
                        "org.tbk.lightning.cln.grpc.host=localhost",
                        "org.tbk.lightning.cln.grpc.port=10001",
    ...
    void errorIfCertFileIsInvalid() {
        this.contextRunner.withUserConfiguration(ClnClientAutoConfiguration.class)
                .withPropertyValues(
                        "org.tbk.lightning.cln.grpc.host=localhost",
                        "org.tbk.lightning.cln.grpc.port=10001",
                        "org.tbk.lightning.cln.grpc.ca-cert-file-path=/dev/null",
                        "org.tbk.lightning.cln.grpc.client-cert-file-path=/dev/null",
                        "org.tbk.lightning.cln.grpc.client-key-file-path=/dev/null"
                ).run(context -> {
                    Throwable startupFailure = context.getStartupFailure();
