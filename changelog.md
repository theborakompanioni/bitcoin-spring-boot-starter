...
- upgrade: update lightning-kmp from v1.4.4 to v1.5.12
- upgrade: update bitcoin-kmp from v0.12.0 to v0.14.0
...
[Unreleased]: https://github.com/theborakompanioni/bitcoin-spring-boot-starter/compare/0.11.0...HEAD
