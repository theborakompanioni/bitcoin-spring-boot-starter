package org.tbk.bitcoin.example.payreq.swagger;
    ...
    OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .title("Bitcoin Payment Request API")
                        .description("A Bitcoin Payment Request API built with bitcoin-spring-boot-starter.")
